...
def get_csv_generator(base_generator):
    class CSVGenerator(base_generator):
        ...
        def __init__(self, config, preprocess_image, csv_data_file, csv_class_file, base_dir=None):
            ...
            super(CSVGenerator, self).__from_config__(config, preprocess_image=preprocess_image)
